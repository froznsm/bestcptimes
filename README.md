# BestCPTimes
App for [PyPlanet](pypla.net).
## Description
BestCPTimes is an app for [PyPlanet](pypla.net) for use in Trackmania TimeAttack. It displays the best driven times at every checkpoint at the top of the UI.
### List UI
